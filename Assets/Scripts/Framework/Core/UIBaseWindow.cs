...
/// 窗口基类
/// </summary>
public class UIBaseWindow : View
{
    ...
    protected bool useShowEfeect = false;
    ...
    public virtual void HideWindowDirectly()
    {
        IsLock = true;
        isShown = false;
        NGUITools.SetActive(this.gameObject, false);
    ...
    protected void ShowOpenEffect() {
        TweenScale ts = GetComponentInChildren<TweenScale>();
        ts.PlayForward();
        ts.ResetToBeginning();
        ts.PlayForward();
    }
