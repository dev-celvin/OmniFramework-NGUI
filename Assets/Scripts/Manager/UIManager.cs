...
public class UIManager : UIManagerBase
{
    ...
    protected override void InitWindowControl()
    {
        ...
        AddWindowInControl(WindowID.WindowID_Access);
        AddWindowInControl(WindowID.WindowID_MainMenu);
        AddWindowInControl(WindowID.WindowID_UserCenter);
        AddWindowInControl(WindowID.WindowID_Anim);
        AddWindowInControl(WindowID.WindowID_Game);
        AddWindowInControl(WindowID.WindowID_Shop);
        AddWindowInControl(WindowID.WindowID_Introduction);
        AddWindowInControl(WindowID.WindowID_Tip);
        AddWindowInControl(WindowID.WindowID_Arena);
        AddWindowInControl(WindowID.WindowID_AR);
        AddWindowInControl(WindowID.WindowID_GainBox);
        AddWindowInControl(WindowID.WindowID_Reward);
        AddWindowInControl(WindowID.WindowID_Splash);
    }
    ...
    public void ShowTip(string text, Action callBack = null) {
        ShowWindow(WindowID.WindowID_Tip);
    }

    public bool CheckPopUpSupport() {
        if (curShownNormalWindow.supportPopUp) return true;
        return false;
    }
